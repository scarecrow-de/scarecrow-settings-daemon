...
"    <annotation name='org.freedesktop.DBus.GLib.CSymbol' value='csd_sharing_manager'/>"
...
static void     csd_sharing_manager_class_init  (GsdSharingManagerClass *klass);
static void     csd_sharing_manager_init        (GsdSharingManager      *manager);
static void     csd_sharing_manager_finalize    (GObject                *object);

G_DEFINE_TYPE (GsdSharingManager, csd_sharing_manager, G_TYPE_OBJECT)
...
static void
csd_sharing_manager_handle_service (GsdSharingManager   *manager,
                                    const char          *method,
                                    ServiceInfo         *service)
{
        char *service_file;
...
static void
csd_sharing_manager_start_service (GsdSharingManager *manager,
                                   ServiceInfo       *service)
{
        ...
        csd_sharing_manager_handle_service (manager, "StartUnit", service);
}

static void
csd_sharing_manager_stop_service (GsdSharingManager *manager,
                                  ServiceInfo       *service)
{
        g_debug ("About to stop %s", service->name);

        csd_sharing_manager_handle_service (manager, "StopUnit", service);
}
...
static void
csd_sharing_manager_sync_services (GsdSharingManager *manager)
{
        GList *services, *l;
...
static gboolean
csd_sharing_manager_enable_service (GsdSharingManager  *manager,
                                    const char         *service_name,
                                    GError            **error)
{
        ServiceInfo *service;
...
static gboolean
csd_sharing_manager_disable_service (GsdSharingManager  *manager,
                                     const char         *service_name,
...
static GVariant *
csd_sharing_manager_list_networks (GsdSharingManager  *manager,
                                   const char         *service_name,
                                   GError            **error)
{
        char **connections;
...
static void
csd_sharing_manager_disable_rygel (void)
{
	GDBusConnection *connection;
	gchar *path;
...
gboolean
csd_sharing_manager_start (GsdSharingManager *manager,
                           GError           **error)
{
        ...
        csd_sharing_manager_disable_rygel ();
...
void
csd_sharing_manager_stop (GsdSharingManager *manager)
{
...
static void
csd_sharing_manager_class_init (GsdSharingManagerClass *klass)
{
...
static void
csd_sharing_manager_init (GsdSharingManager *manager)
{
        guint i;
