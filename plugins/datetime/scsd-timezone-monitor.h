...
#define GSD_TYPE_TIMEZONE_MONITOR                  (csd_timezone_monitor_get_type ())
...
GType csd_timezone_monitor_get_type (void) G_GNUC_CONST;

GsdTimezoneMonitor *csd_timezone_monitor_new (void);
