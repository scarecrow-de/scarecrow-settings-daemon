...
G_DEFINE_TYPE_WITH_PRIVATE (GsdTimezoneMonitor, csd_timezone_monitor, G_TYPE_OBJECT)
                 ...
                 gpointer      user_data)
{
        ...
        priv = csd_timezone_monitor_get_instance_private (user_data);
...
{
        GsdTimezoneMonitorPrivate *priv = csd_timezone_monitor_get_instance_private (self);
...
GsdTimezoneMonitor *
csd_timezone_monitor_new (void)
{
        return g_object_new (GSD_TYPE_TIMEZONE_MONITOR, NULL);
}

static void
csd_timezone_monitor_finalize (GObject *obj)
{
        GsdTimezoneMonitor *monitor = GSD_TIMEZONE_MONITOR (obj);
        GsdTimezoneMonitorPrivate *priv = csd_timezone_monitor_get_instance_private (monitor);
        ...
        G_OBJECT_CLASS (csd_timezone_monitor_parent_class)->finalize (obj);
}

static void
csd_timezone_monitor_class_init (GsdTimezoneMonitorClass *klass)
{
        GObjectClass *object_class = G_OBJECT_CLASS (klass);

        object_class->finalize = csd_timezone_monitor_finalize;
...
static void
csd_timezone_monitor_init (GsdTimezoneMonitor *self)
{
        GError *error = NULL;
        GsdTimezoneMonitorPrivate *priv = csd_timezone_monitor_get_instance_private (self);
