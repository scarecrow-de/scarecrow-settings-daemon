...
static void     csd_rfkill_manager_class_init  (GsdRfkillManagerClass *klass);
static void     csd_rfkill_manager_init        (GsdRfkillManager      *rfkill_manager);
static void     csd_rfkill_manager_finalize    (GObject                    *object);

G_DEFINE_TYPE (GsdRfkillManager, csd_rfkill_manager, G_TYPE_OBJECT)

static gpointer manager_object = NULL;

static void
csd_rfkill_manager_class_init (GsdRfkillManagerClass *klass)
{
...
static void
csd_rfkill_manager_init (GsdRfkillManager *manager)
{
}
...
gboolean
csd_rfkill_manager_start (GsdRfkillManager *manager,
                         GError         **error)
{
...
void
csd_rfkill_manager_stop (GsdRfkillManager *manager)
{
