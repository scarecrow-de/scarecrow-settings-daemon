...
G_DEFINE_TYPE (GsdWwanManager, csd_wwan_manager, G_TYPE_OBJECT)
...
static void
csd_wwan_manager_cache_mm_object (GsdWwanManager *self, MMObject *obj)
{
...
object_added_cb (GsdWwanManager *self, GDBusObject *object, GDBusObjectManager *obj_manager)
{
        ...
        csd_wwan_manager_cache_mm_object (self, MM_OBJECT(object));
}
...
get_all_modems (GsdWwanManager *self)
{
        ...
        for (l = list; l != NULL; l = l->next)
                csd_wwan_manager_cache_mm_object (self, MM_OBJECT(l->data));
...
gboolean
csd_wwan_manager_start (GsdWwanManager *self,
                        GError        **error)
{
...
void
csd_wwan_manager_stop (GsdWwanManager *self)
{
...
static void
csd_wwan_manager_set_unlock_sim (GsdWwanManager *self, gboolean unlock)
{
...
static void
csd_wwan_manager_set_property (GObject        *object,
                               guint           prop_id,
                               const GValue   *value,
                               GParamSpec     *pspec)
{
        ...
        case PROP_UNLOCK_SIM:
                csd_wwan_manager_set_unlock_sim (self, g_value_get_boolean (value));
                break;
        default:
...
static void
csd_wwan_manager_get_property (GObject        *object,
                               guint           prop_id,
                               GValue         *value,
                               GParamSpec     *pspec)
{
...
static void
csd_wwan_manager_dispose (GObject *object)
{
        GsdWwanManager *self = GSD_WWAN_MANAGER (object);
        ...
        G_OBJECT_CLASS (csd_wwan_manager_parent_class)->dispose (object);
}

static void
csd_wwan_manager_class_init (GsdWwanManagerClass *klass)
{
        GObjectClass   *object_class = G_OBJECT_CLASS (klass);

        object_class->get_property = csd_wwan_manager_get_property;
        object_class->set_property = csd_wwan_manager_set_property;
        object_class->dispose = csd_wwan_manager_dispose;
...
static void
csd_wwan_manager_init (GsdWwanManager *self)
{
