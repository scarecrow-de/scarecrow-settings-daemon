...
static void     csd_keyboard_manager_class_init  (GsdKeyboardManagerClass *klass);
static void     csd_keyboard_manager_init        (GsdKeyboardManager      *keyboard_manager);
static void     csd_keyboard_manager_finalize    (GObject                 *object);

static void     update_gtk_im_module (GsdKeyboardManager *manager);

G_DEFINE_TYPE (GsdKeyboardManager, csd_keyboard_manager, G_TYPE_OBJECT)
...
gboolean
csd_keyboard_manager_start (GsdKeyboardManager *manager,
                            GError            **error)
{
        gnome_settings_profile_start (NULL);
...
void
csd_keyboard_manager_stop (GsdKeyboardManager *manager)
{
...
static void
csd_keyboard_manager_class_init (GsdKeyboardManagerClass *klass)
{
...
static void
csd_keyboard_manager_init (GsdKeyboardManager *manager)
{
}
...
migrate_keyboard_settings (void)
{
        ...
        csd_settings_migrate_check ("io.github.scarecrow_de.settings-daemon.peripherals.keyboard.deprecated",
