...
G_DEFINE_TYPE (GsdNightLight, csd_night_light, G_TYPE_OBJECT);

static GDateTime *
csd_night_light_get_date_time_now (GsdNightLight *self)
{
...
void
csd_night_light_set_date_time_now (GsdNightLight *self, GDateTime *datetime)
{
        if (self->datetime_override != NULL)
...
void
csd_night_light_set_smooth_enabled (GsdNightLight *self,
                                    gboolean smooth_enabled)
{
...
static void
csd_night_light_set_temperature_internal (GsdNightLight *self, gdouble temperature)
{
...
static void
csd_night_light_set_temperature (GsdNightLight *self, gdouble temperature)
{
        /* immediate */
...
static void
csd_night_light_set_active (GsdNightLight *self, gboolean active)
{
        ...
        if (!active)
                csd_night_light_set_temperature (self, GSD_COLOR_TEMPERATURE_DEFAULT);
...
void
csd_night_light_set_disabled_until_tmw (GsdNightLight *self, gboolean value)
{
...
gboolean
csd_night_light_get_disabled_until_tmw (GsdNightLight *self)
{
        return self->disabled_until_tmw;
}

void
csd_night_light_set_forced (GsdNightLight *self, gboolean value)
{
...
gboolean
csd_night_light_get_forced (GsdNightLight *self)
{
        return self->forced;
}

gboolean
csd_night_light_get_active (GsdNightLight *self)
{
        return self->cached_active;
}

gdouble
csd_night_light_get_sunrise (GsdNightLight *self)
{
        return self->cached_sunrise;
}

gdouble
csd_night_light_get_sunset (GsdNightLight *self)
{
        return self->cached_sunset;
}

gdouble
csd_night_light_get_temperature (GsdNightLight *self)
{
        return self->cached_temperature;
}

void
csd_night_light_set_geoclue_enabled (GsdNightLight *self, gboolean enabled)
{
        self->geoclue_enabled = enabled;
}

gboolean
csd_night_light_start (GsdNightLight *self, GError **error)
{
        night_light_recheck (self);
        poll_timeout_create (self);
...
static void
csd_night_light_class_init (GsdNightLightClass *klass)
{
...
static void
csd_night_light_init (GsdNightLight *self)
{
