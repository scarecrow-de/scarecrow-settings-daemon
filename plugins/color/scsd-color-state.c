...
static void     csd_color_state_class_init  (GsdColorStateClass *klass);
static void     csd_color_state_init        (GsdColorState      *color_state);
static void     csd_color_state_finalize    (GObject            *object);

G_DEFINE_TYPE (GsdColorState, csd_color_state, G_TYPE_OBJECT)
...
void
csd_color_state_set_temperature (GsdColorState *state, guint temperature)
{
...
guint
csd_color_state_get_temperature (GsdColorState *state)
{
...
void
csd_color_state_start (GsdColorState *state)
{
...
void
csd_color_state_stop (GsdColorState *state)
{
        g_cancellable_cancel (state->cancellable);
}

static void
csd_color_state_class_init (GsdColorStateClass *klass)
{
...
static void
csd_color_state_init (GsdColorState *state)
{
