                                 ...
                                 GError                **error)
{
	...
	manager->interface_settings = g_settings_new ("io.github.scarecrow.desktop.interface");
	manager->a11y_apps_settings = g_settings_new ("io.github.scarecrow.desktop.a11y.applications");
